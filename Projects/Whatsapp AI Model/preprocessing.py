...
def extract_speaker_and_message(line):
    ...
    for i in range(start_index, len(line)):
        if line[i:i+5] == "Naina" or line[i:i+3] == "Adi":
            end_index = i
            break
    ...
    elif line.startswith("Naina Avadh..."):
        speaker = "Naina"
        message = line.replace("Naina Avadh...: ", "").strip()
    return speaker, message

input_file = "D:/Python/Projects/Whatsapp AI Model/Dataset/WhatsApp Chat with Naina Avadh....txt"
data = preprocess_chat_data(input_file)

output_file = "preprocessed_data_Naina.json"
